                ...
                var body = JSON.stringify(
                    {
                        ...
                        "data": {
                            "title": `${data[i].KpiName.trim()}`,
                            "measure": `${data[i].currency.trim()}${data[i].KpiValue.trim()}${data[i].Percentage.trim()}`,
                            "change": `${data[i].PercentSwing.trim()}`,
                            "trend": trend,
                            "yoyComparison": `${data[i].YoyGrowth.trim()}`
                        }
                    })
                var options = {
                    'method': 'POST',
